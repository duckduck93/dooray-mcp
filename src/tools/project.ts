  ...
  server.registerTool(
    "get_projects",
    {
      ...
      inputSchema: {
        ...
        scope: z.enum(["private", "public"]).optional().describe("Filter by access scope. private: members only, public: all org members"),
        type: z.enum(["private", "public"]).optional().describe("Filter by project type. private: personal project, public: general project (default)"),
      },
    },
